...
Message.create(company_id: @company.id, company_message: "Best Dam Coffee Ever??", positive_message: 'Thank you for the awesome review guy', negative_message: "Oh no, I'm sorry you feel that way")
Notification.create(company_id: @company.id, positive_notification: 'Positive Review! Great job guys!', negative_notification: "DAM, Another negative review... let's get to the bottom of this")
